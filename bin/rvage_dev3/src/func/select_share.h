...
//  rvage
//
//  Created by Patrick Albers on 04/09/2016.
...
{
	std::cout << "Generating sharing index at target positions" << std::endl;
	std::clog << "Generating sharing index at target positions" << std::endl;
...
{
	std::cout << "Generating sharing index at target position: " << pos << std::endl;
	std::clog << "Generating sharing index at target position: " << pos << std::endl;
